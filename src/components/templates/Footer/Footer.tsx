...
export const Footer = () => {
	...
	return (
		<footer className="bg-[#fe860b] bg-opacity-5 p-4 md:p-8 lg:p-8">
			<section className="w-full flex flex-col md:flex-col lg:flex-row justify-between gap-4 mb-8">
				<div className="md:w-6/12 lg:w-6/12">
					<h4 className="text-xl md:text-3xl mb-4 text-[#fe860b]">
						Sekilas Tentang Kami
					</h4>
					<p className="md:mr-[10rem] lg:mr-[10rem] mr-0 mb-4">
						Bupati.Ai memanfaatkan Artificial Intelligence dan big data untuk
					...
					<Button
						variant="outline"
						className="border-2 border-[#fe860b] hover:border-[#F04279] bg-transparent hover:bg-transparent font-bold text-[#fe860b] hover:text-[#F04279] rounded-full"
					>
						LEBIH LANJUT
						<span className="ml-2">
							<MoveRight />
				...
				<div className="md:w-6/12 lg:w-6/12">
					...
					<Button className="bg-[#fe860b] hover:bg-[#F04279] font-bold text-white">
						KIRIM
					</Button>
				</div>
			</section>

			<section className="w-full border-t-2 border-t-[#fe860b] pt-4">
				<p>Copyright © 2023 BUPATI.AI - All rights reserved.</p>
